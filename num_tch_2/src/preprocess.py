...
def main():
    ...
    torch.save(train_loader, os.path.join(processed_dir, "train_loader_stu"))
    torch.save(test_loader, os.path.join(processed_dir, "test_loader_stu"))
    torch.save(df_test, os.path.join(processed_dir, "test_df_stu"))
